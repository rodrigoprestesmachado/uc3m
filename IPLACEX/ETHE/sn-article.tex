...
\title[Article Title]{Analyzing Students Strategies When Interacting with
...
For more than a decade, Chilean higher education has experienced a substantial
increase in enrolment. In 2024, total enrolment reached 1,777,340 students,
concentrated primarily in universities (55.3\%), followed by professional
institutes (Institutos Profesionales, 33.4) and technical training centres
(Centros de Formación Técnica, 11.4\%). Within this context, distance-learning
programmes constitute a significant trend, accounting for 12.4\% of total
undergraduate enrolment. Between 2023 and 2024, distance programmes grew by
11.8\%—adding 16,700 students—whereas full-time on-campus programmes rose by
1.8\%, with nearly 16,000 additional students \citep{SIES2024Matriculas}.
These figures underscore the growing importance of distance education in Chile
and highlight the need to analyze institutions where technology plays a central
role in learning processes.

At Instituto Profesional Iplacex, enrolment has risen steadily, reaching 41,028
students in 2024, of whom 12,044 are new entrants. These numbers position
Iplacex as the largest distance-learning higher-education institution in Chile.
The average age of newly enrolled students is 35 years, with the majority
between 30 and 39. Consequently, the student body largely comprises working
adults seeking to enhance their career prospects through further study—either
upgrading existing skills (upskilling) or acquiring competencies for new roles
(reskilling).

Within this framework, technology is pivotal to the academic processes of
distance-learning institutions. In addition to conventional platforms such as
Blackboard, Canvas and Moodle, generative artificial intelligence (GenAI) has
recently entered higher education, enabling new technological applications that
support students’ learning experiences. At Iplacex, GenAI has been deployed
through chatbots in approximately 85\% of the institution’s courses.

The innovation implemented at Iplacex responds to the need for a virtual
assistant embedded in each course via an API integrated into Blackboard. Each
chatbot is configured with a prompt that supplies course-specific information,
providing answers related both to course content and administrative matters.

GenAI presents new opportunities for higher-education institutions
\citep{Puryear22}, one of the most prominent being conversational chatbots
(Labadze et al., 2023). Chatbots may be defined as “conversational agents that
simulate human dialogue through natural-language processing and machine-learning
algorithms” \citep[p.~1]{Stoehr24A}.

International evidence concerning GenAI indicates diverse effects on students,
prompting a redefinition of teaching and learning processes  \citep{Bahroun23}.
GenAI is regarded as a key factor in personalizing and adapting
distance-education experiences \citep{Essa23, Ilic23, Kadaruddin23} and
influencing both the academic and everyday lives of students
\citep{Chen20Review}. Research has further documented positive student
attitudes toward GenAI at undergraduate and postgraduate levels  \citep{chan23}.

Studies also show that student use of chatbots can enhance learning, leading to
improved understanding and academic performance \citep{Callejo24,Lo24}. Their
use is associated with more effective learning regulation \citep{Baha24} and
significantly supports self-regulation, particularly among students with prior
technical or disciplinary training \citep{Xia23}. In addition, conversational
agents positively affect students’ academic engagement \citep{Lo24} and
motivation levels \citep{Cubillos25}. Learning, engagement and motivation are
critical factors in distance education \citep{Abdelghani23}.

In Chile, research on GenAI remains incipient, with most studies originating in
North America, Asia and Europe \citep{Rivadeneira24}. Preliminary Chilean
findings \citep{Romero24} confirm the relevance of AI for higher-education
institutions \citep{GonzalezCampos24} and its influence on student motivation
\citep{Cubillos25}.


Methodologically, research on GenAI and conversational agents has employed
literature reviews \citep{Anchapaxi24, Choque23, Dempere23, GarciaSanchez23,
Labadze23, Lo24, Romero24}, qualitative approaches \citep{GonzalezCampos24,
Kadaruddin23, MoranOrtega24, Stone23}, quantitative designs
\citep{Carrasco24, chan23, Cherrez24}—some with control groups
\citep{Baha24, Cubillos25, Vazquez21}—and, to a lesser extent, mixed-methods
studies \citep{Polakova24}.

Against this backdrop, the present study seeks to identify the profile of
students who have interacted with the chatbot.
...
This section outlines the tools and procedures used in this study. Iplacex
ChatBot served as the GenAI tool for educational purposes, and the method was
structured into three distinct phases, each designed to systematically assess
its interaction with students.

\subsection{Iplacex ChatBot}

Iplacex ChatBot is an educational chatbot powered by ChatGPT 3.5 and enhanced
with Retrieval-Augmented Generation (RAG) \citep{Sun24}. RAG is an AI technique
that integrates information retrieval with generative models. It first retrieves
...
Iplacex ChatBot's performance revealed that most students found its responses
